...
--
-- Host: 127.0.0.1
-- Tempo de geração: 16/09/2025 às 13:45
...
INSERT INTO `voluntario` (`id`, `nome_voluntario`, `email`, `senha`, `telefone`, `whatsapp`, `categoria_trabalho`, `periodo`, `cpf`, `estado_social`, `pcd`, `sobre`, `quant_cadastro`) VALUES
(4, 'Mig', 'mi@gmail.com', '123', '11111111111', '5511111111111', 'tecnologia', 'manhã', '11111111111', 'Estudante Fundamental', 'Não', 'oi, sou legal', 0);
