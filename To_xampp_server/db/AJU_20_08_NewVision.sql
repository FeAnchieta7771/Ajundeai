...
--
-- Host: 127.0.0.1
-- Tempo de geração: 21/08/2025 às 00:44
...
CREATE TABLE `voluntario` (
  ...
  `telefone` varchar(20) NOT NULL,
  `whatsapp` varchar(20) DEFAULT NULL,
  `categoria_trabalho` enum('saúde','eventos','animais','crianças','educação','tecnologia','assistencia','administração','meio ambiente','outros') NOT NULL,
