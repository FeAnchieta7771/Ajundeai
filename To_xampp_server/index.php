...
<body>
  ...
  <div class="hero">
    ...
    <div class="search-bar">
      <form method="GET" action="filter.php">
        ...
        <input class="search-input" type="text" placeholder="Vaga de meio ambiente, cuidadores, ONG ..."
          name="filter_user" />
  ...
  <div class="tryLogin">
    ...
    <br />
    <div class="buts">
      <a class="buttonTryLogin1" id="Cadastro_volunt" href="account.php">Criar conta de <strong>Voluntário</strong></a>
      <p>OU</p>
  ...
  <div class="parent">
    <div class="div1">
      ...
      <div class="objects">
        ...
        <a class="buttonTryLogin3" id="Cadastro_volunt" href="account.php"><span class="material-symbols-outlined">diversity_1</span>
          <strong> Fazer parte da Diferença!</strong></a>
      </div>
    </div>
    <div class="div2">
      <img class="image_div" src="img/imgHome1.png"
        style="width: 100%; max-height: 500px; object-fit: fill; height: auto" />
    </div>

    <div class="div3">
      <img class="image_div" src="img/imgHome3.png"
        style="width: 100%; max-height: 500px; object-fit: fill; height: auto" />
    </div>
      ...
      <form method="GET" action="php_functs/php_methods/redirect_filter.php">
        ...
        <div class="divB9">
          <button type='submit' name='category_button' value='administração'>
            <section class="titleCard">
              <br />
              <i class="bx bxs-message-circle-exclamation" style="font-size: 60px"></i>
              <h2>ADMINISTRAÇÃO</h2>
            </section>
